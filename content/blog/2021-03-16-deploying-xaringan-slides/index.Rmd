...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan("https://spcanelon.github.io/RLadies-xaringan-template", 
                              ratio = "4:3")
```

> Try navigating through the slides `r emo::ji("point_up")` with your left/right arrow keys and press the letter "P" on your keyboard to see some notes in Presenter View
...
9. When you're ready to deploy your slides, you can use the `usethis::use_github_pages()` function which makes the process of deploying via GitHub Pages super easy. I recommend pointing `branch` to the name of your primary branch.
    ...
    > Also, you only need to follow this step _once_ to deploy your slides to the web. As long as you remember to push to your repo any changes that you make to your slides (Rmd and HTML), GitHub Pages will know how to render them.
