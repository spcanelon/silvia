...
subtitle: An overview of the [RStudio Instructor certification](https://education.rstudio.com/trainers/#info)
  process and collection of resources to support anyone on their certification journey.
summary: An overview of the [RStudio Instructor certification](https://education.rstudio.com/trainers/#info)
  process and collection of resources to support anyone on their certification journey.
lastmod: 2021-03-14
featured: yes
draft: no
...
{{% alert note %}}
February 12th, 2021 was [Greg Wilson's last day at RStudio](https://twitter.com/gvwilson/status/1360304482496614402?s=20). This means he is no longer running the instructor training program, so the future of the program is unclear. You may want to reach out to [traininginstructor@rstudio.com](mailto:traininginstructor@rstudio.com) with any specific questions.

You can also jump down in this blog post to [Teaching resources](#teaching-resources) to find a consolidated list of materials previously taught as part of the RStudio certification program (slide deck, Teaching Tech Together), along with some additional videos on evidence-based teaching -- thanks to Yanina for digging up these videos!
...
- `r emo::ji("bolivia")` `r emo::ji("netherlands")` [Paloma Rojas-Saunero](https://education.rstudio.com/trainers/people/rojas-saunero+paloma/) shared her view as a Ph.D. candidate with experience teaching R in R-Ladies workshops and as a teaching assistant in biostatistics courses.
...
![](RIT-post-concept-map.jpg)

The third day of training, our cohort had the pleasure of learning all about using the [`learnr` `r emo::ji("package")`](https://rstudio.github.io/learnr/) to build interactive R tutorials, from [Mine Çetinkaya-Rundel](https://education.rstudio.com/trainers/people/cetinkaya-rundel+mine/):

- <i class="fas fa-link"></i> Course website: [rstudio/io/rit](https://rstudio-education.github.io/instructor-training/)
...
- [Slides for the instructor training course by Greg Wilson - Google Drive](https://drive.google.com/drive/folders/13ohFt3D0EJ5PDbMaWTxnHH-hwA7G0IvY)
- [Teaching Tech Together](https://teachtogether.tech/)
- [Greg Wilson | Teaching Online at Short Notice | RStudio (2020) - YouTube](https://www.youtube.com/watch?v=-2enQV3Dfng)
- [Greg Wilson | Evidence Based Teaching What We Know and How to Use I EuroSciPy 2015 - YouTube](https://www.youtube.com/watch?v=kmVKGxPlTvc)
- [rstudio-education/r4ds-instructors: Instructors' Guide to accompany "R for Data Science"](https://github.com/rstudio-education/r4ds-instructors)
