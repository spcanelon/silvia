...
link:
  name: 'R Markdown'
  url: "/2020-05-06-migrating-from-trello-to-airtable.Rmd"
---

![**Fig 1.** Trello to Airtable migration using the example in this tutorial.](/post/2020-05-05-migrating-from-trello-to-airtable/trello-to-airtable-main.png)
...
> Shout out to the [Silicon Valley Democratic Socialists of America](https://siliconvalleydsa.org/) who provided inspiration and support! Their mutual aid network is extensive and operates at an impressive scale. Get connected with the South Bay Mutual Aid network here: https://www.southbay.aidnetwork.org/
...
- **_attachments folder_** containing any content you've attached to your cards using an URL. 
...
- Rendered markdown from your card descriptions. Airtable _does_ support markdown in its "long description" field type, but it doesn't automatically render from imported text.
...
## Data prepping
The `lubridate` package was used here.
