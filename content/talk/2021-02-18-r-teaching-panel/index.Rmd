...
```{r echo=FALSE, fig.align='center', fig.alt='Concept Maps: in practice. An educator can teach one subsection of the concept map at a time and then provide an assessment. A more detailed description available in slide presenter notes at http://tiny.cc/rladies-phl-teaching-spc'}
knitr::include_graphics("concept-map.png")
```

```{r, echo=FALSE, out.width="40%", fig.align='center', fig.alt='Logo for R-Ladies Philly featuring the Liberty Bell in the background'}
