...
source(here::here("project", "2024-06-16-ccd-sips", "2024", "R", "ccd_sips_functions.R"))

specials <- readr::read_rds(here::here("project", "2024-06-16-ccd-sips", "2024", "specialsGeocoded.Rds"))

create_table(specials)
```
