...
```{r, echo=FALSE, out.width="100%", fig.alt="Foundational: 1) Vision, 2) safe environment, and 3) organizing team. Design: 4) Counter bias, 5) virtual/hybrid, 6) accessibility, 7) language, 8) communication, 9) finance. Continuity: 10) pass the torch"}
knitr::include_graphics("featured.png")
```
<p class="caption" style="text-align:left;"><b>Figure 1.</b> Schematic diagram of the rules organized in 3 groups: foundation (Rules 1 to 3), design (Rules 4 to 9), and continuity (Rule 10).</p>
